...
// Route::group(['middleware' => ['auth']], function () {
    Route::group(['prefix' => 'back-office', 'as' => 'backOffice.'], function () {
        Route::group(['prefix' => 'purchasing', 'as' => 'purchasing.'], function () {
         ...
         Route::group(['prefix' => 'non-essential-purchasing-order', 'as' => 'non-essential-purchasing-order.'], function () {
            Route::match(['put', 'patch'], 'approve-many', ['as' => 'approve-many', 'uses' => 'BackOffice\NonEssentialPurchasingOrderController@approveMany']);
            Route::match(['delete'], 'destroy-many', ['as' => 'destroy-many', 'uses' => 'BackOffice\NonEssentialPurchasingOrderController@destroyMany']);
            Route::match(['get'], '{id}/duplicate', ['as' => 'duplicate', 'uses' => 'BackOffice\NonEssentialPurchasingOrderController@duplicate']);
            Route::match(['patch'], '{id}/patch-status', ['as' => 'patch-status', 'uses' => 'BackOffice\NonEssentialPurchasingOrderController@patchStatus']);
            Route::match(['post'], 'store-duplicate', ['as' => 'store-duplicate', 'uses' => 'BackOffice\NonEssentialPurchasingOrderController@storeDuplicate']);

            Route::match(['get'], 'excel', ['as' => 'excel', 'uses' => 'BackOffice\NonEssentialPurchasingOrderController@excel']);
        ...
        Route::match(['delete'], 'back-office/purchasing-order/destroy-many', ['as' => 'purchasing-order.destroy-many', 'uses' => 'BackOffice\PurchasingOrderController@destroyMany']);
        ...
        Route::group(['prefix' => 'setting', 'as' => 'setting.'], function () {
            ...
            Route::get('company-group/excel', 'BackOffice\Setting\CompanyGroupController@excel');
            ...
            Route::match(['put', 'patch'], 'user/{id}/status', ['as' => 'user.status', 'uses' => 'BackOffice\Setting\UserController@status']);
            Route::match(['put', 'patch'], 'user/{id}/restore', ['as' => 'user.restore', 'uses' => 'BackOffice\Setting\UserController@restore']);
            Route::match(['post'], 'user/deleteAll', ['as' => 'user.deleteAll', 'uses' => 'BackOffice\Setting\UserController@deleteAll']);
            Route::match(['post'], 'user/excel', ['as' => 'user.excel', 'uses' => 'BackOffice\Setting\UserController@excel']);
