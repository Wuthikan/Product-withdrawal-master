            ...
            <td class="col-1">
              <div class="col-1-content" >
                ...
                <div class="form-group">
                  <a class="btn btn-default-background" href="{{ url("back-office/setting/platform/create") }}">
            ...
            <td class="blank">
              ...
              <div class="buttons">
                @if( $p->trashed() )
                  ...
                  @else 
                  <a class="btn btn-ngin btn-default" href="{{ url("back-office/setting/platform/". $p->id ."/edit") }}">
                    <span class="btn-label">
