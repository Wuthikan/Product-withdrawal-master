            ...
            <td class="col-1">
              <div class="col-1-content" >
                ...
                <div class="form-group">
                  <a class="btn btn-default-background" href="{{ url("back-office/setting/item-type/create") }}">
            ...
            <td class="blank">
              ...
              <div class="buttons">
                @if( $c->trashed() )
                  ...
                  @else
                  <a class="btn btn-ngin btn-default" href="{{ url("back-office/setting/item-type/". $c->id ."/edit") }}">
                    <span class="btn-label">
