...
<section class="x_content">
    ...
    <div class="form-inline form-header-index">
      <div class="flex-parent form-table center">
        ...
        <div class="form-group">
            <a class="btn btn-default-background" href="{{ route("backOffice.setting.product.create") }}">
        ...
        <form action="{{ route('backOffice.setting.product.index') }}" method="post" class="form-group w-8 mr-1">
          <div class="icon-addon addon-sm">
            <input type="text" name="searchAll" placeholder="SEARCH" class="form-control search" id="SEARCH">
            <label for="search"  class="glyphicon glyphicon-search" rel="tooltip" title="email"></label>
          </div>
        </form>

        <form action="{{ route('backOffice.setting.product.index') }}" method="post" class="form-group form-fixed-width flex-item">
          <div class="icon-addon addon-sm flex-parent">
            <input type="text" name="search" placeholder="BARCODE | PRODUCT CODE | SERIAL" class="form-control search" id="SEARCH2" data-action="typeaheadProduct">
          ...
          <div class="panel panel-default">
            ...
            <div class="panel-heading" role="tab" id="heading-{{$row}}">
              <h4 class="panel-title">
                <a class="flex-parent center" role="button" data-toggle="collapse" data-parent="#backlog" href="#collapse-{{$row}}" aria-expanded="true">
                ...
                <div class="col-md-9">
                  <div class="no-padding mb-1">
                    <div class="text-black category-row flex-parent">
                      <div class="flex-item flex-parent center"><span class="icon"><i class="fa fa-book"></i></span> <b>PUBLISHER: {{ $product->publisher->name }}</b></div>
                      <div class="flex-item flex-parent center"><span class="icon"><i class="fa fa-user"></i></span> <b>No.PLAYER: {{ $product->number_of_player }}</b></div>
                      <div class="flex-item flex-parent center"><span class="icon"><i class="fa fa-crosshairs"></i></span> <b>RATING: {{ $product->rating }}</b></div>
                      <div class="flex-item flex-parent center"><span class="icon"><i class="fa fa-pencil-square-o"></i></span> <b>GENRE: {{ $product->genres->company_name }}</b></div>
                  ...
                  <div class="flex-parent">
                      ...
                      <table class="table ngin-table">
                        <thead>
                          <tr>
                            ...
                            <th class="text-left pl-0">{{ $edition->name }}</th>
                            @endforeach
                          </tr>
                        </thead>
                        <tbody>
                    ...
                    <div class="vertical-buttons pt-1">
                      <a type="button" class="btn btn-ngin btn-default" href="{{ url("back-office/inquiry/1/edit") }}">
  ...
  <section class="row page-showing-pagination">
    <div class="col-xs-6 showing">
      Showing 1-10 of {{ $products->total() }}
    </div>
