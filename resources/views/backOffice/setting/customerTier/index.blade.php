              ...
              <td class="col-1" style="min-width:145px;width: 1%;white-space: nowrap;">
                <div class="col-1-content" >
                  ...
                  <div class="form-group">
                    <a class="btn btn-default-background" href="{{ url("back-office/setting/customer-tier/create") }}">
          ...
          <tbody>
            <tr>
              <td class="blank">
                ...
                <div class="buttons">
                  @if (!$customerTier->trashed())
                    <a class="btn btn-ngin btn-default" href="{{ route('backOffice.setting.customer-tier.edit',  $customerTier->id) }}">
