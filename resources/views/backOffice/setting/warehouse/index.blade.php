                ...
                <td class="col-1" style="min-width:145px;width: 1%;white-space: nowrap;">
                  <div class="col-1-content">
                    ...
                    <div class="form-group">
                      <a class="btn btn-default-background" href="{{ url("back-office/setting/warehouse/create") }}">
                  ...
                  @foreach($Warehouses as $index => $Warehouse)
                    ...
                    <tr>
                      ...
                      <td class="actions align-center">
                          <div class="buttons">
                            @if(!$Warehouse->deleted_at) 
                            <a class="btn btn-ngin btn-default" href="{{route('backOffice.setting.warehouse.edit',$Warehouse->id)}}">
