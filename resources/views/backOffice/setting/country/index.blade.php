      ...
      <div class="form-inline-row">
        <div class="col-1">
          ...
          <div class="form-group">
            <a class="btn btn-default-background" href="{{ url("back-office/setting/country/create") }}">
    ...
    <tbody>
      <tr @if($data->trashed()) class="is-trashed" @endif>
        ...
        <td class="actions align-center">
          <div class="buttons">
            @if(!$data->trashed())
            <a class="btn btn-ngin btn-default" href="{{route('backOffice.setting.country.edit', $data->id)}}">
