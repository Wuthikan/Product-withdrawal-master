          ...
          <div class="media-left">
              <div class="upload-btn-wrapper">
                  <img
                    ...
                    class="profilePicture @if(old('image_show') == 'image1') checked @endif">
              ...
              <div class="upload-btn-wrapper">
                  <img
                    src="{{asset('images/avatar.png')}}"
                    class="profilePicture @if(old('image_show') == 'image2') checked @endif">
              ...
              <div class="form-group">
                  ...
                  <textarea name="description_status" class="form-control" rows="3">{{ old('description_status') }}</textarea>
              </div>
              <input type="hidden" id="imageShow" name="imageShow" value="{{ old('image_show') }}">
          </div>
                  ...
                  <div class="col-xs-6">
                      <div class="form-group">
                          ...
                          <div class="input-group date" id="datepicker" >
                              <input type="text" class="form-control" name="register_date" id="register_date" value="{{old('register_date')}}"/>
