            ...
            <td class="col-1" style="min-width: 10% !important; width: 12% !important;">
              <div class="col-1-content" >
                ...
                <div class="form-group">
                  <a class="btn btn-default-background" href="{{ url("back-office/news-and-event/create") }}">
        ...
        <tbody>
          ...
          <tr @if($method->trashed()) style="color: #ccc;text-decoration: line-through;" @endif>
            <td class="blank">
              ...
              <div class="buttons">
                   @if(!$method->trashed())
                   <a class="btn btn-ngin btn-default" @if($method->trashed()) disabled @else href="{{ route('backOffice.news-and-event.edit', ['id'=>$method->id]) }}" @endif>
