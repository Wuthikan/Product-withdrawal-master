						...
						<td class="col-1">
							<div class="col-1-content" >
								...
								<div class="form-group">
									<a class="btn btn-default-background" href="{{ url("back-office/customer-return-order/create-from-tax-invoice") }}">
								...
								<div class="form-group">
									<a class="btn btn-default-background" href="{{ url("back-office/customer-return-order/create-from-customer") }}">
