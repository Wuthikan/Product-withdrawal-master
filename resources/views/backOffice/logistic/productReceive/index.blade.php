                ...
                <div class="col-xs-12">
                    <div class="form-top-bar">
                        ...
                        <div class="form-group">
                            <a class="btn btn-default-background" href="{{ url("back-office/logistic/product-receive/create") }}">
										...
										<tbody>
											...
											<tr>
												...
												<td colspan="6">
                                                    ...
                                                    <a class="btn btn-ngin btn-default" href="{{ url(" back-office/inquiry/1/edit
                                                        ") }}">
										...
										<tbody>
											...
											<tr>
												...
												<td colspan="6">
													...
													<button type="button" class="btn btn-ngin btn-default" onclick="event.stopPropagation();window.location='{{ url(" back-office/inquiry/1/edit
														") }}'">
														<span class="btn-label">
															<i class="fa fa-pencil-square-o success" aria-hidden="true"></i>
														</span>Edit
