			...
			<div class="row">
				...
				<tr>
					...
					<div class="col-1-content" >
						...
						<a class="btn btn-default-background" href="{{ url("back-office/other/product-borrow/create") }}">
												...
												<div class="row btn-control">
													<div class="col-xs-5 col-xs-offset-7">
														<ul class="list list-inline">
															<li>
																<a class="btn btn-ngin btn-default" href="{{ url("back-office/other/product-borrow").'/'.$i.'/edit' }}">
