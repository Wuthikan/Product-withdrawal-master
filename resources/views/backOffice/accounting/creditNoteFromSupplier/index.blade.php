                ...
                <td class="col-1" style="min-width: inherit;width: 250px;">
                    <div class="col-1-content" >
                        ...
                        <div class="form-group">
                            <a class="btn btn-default-background" href="{{ route("backOffice.accounting.credit-note-from-supplier.create") }}">
				...
				<div class="bk-group1">
					<table class="bk-table" border="0">
					  ...
					  <tr>
						<td></td>
						<td rowspan="2">
						  <a class="btn btn-ngin btn-default" href="#" style="height: 29px;line-height: 22px;">
